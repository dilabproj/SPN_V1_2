...
from models.snippet_backbone import HeartNetIEEE,ECGHB,D3CNN,ResCNN
...
class SPL(nn.Module):
    ...
    def __init__(self, input_size = 12, hidden_size = 256, hidden_output_size = 1, output_size = 9):
        ...
        #self.BaseCNN = ECGHB(input_size).cuda()
    ...
    def applyLoss(self, y_hat, labels, alpha = 0.3, beta = 0.001, gamma = 0.5):
        ...
        loss = self.loss_c + alpha * self.loss_r + self.loss_b + beta * self.time_penalty
